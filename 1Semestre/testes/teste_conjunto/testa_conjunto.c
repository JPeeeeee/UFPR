...
int main (void) {
    ...
    imprime (b);
    printf ("A saida deve ter sido todos os números de 1 a 17, senao esta errado\n");
    ...
    printf("\n");
    printf("Teste do retirar, tem que ter impresso todos numeros de 20 ate 1, regressivamente\n");
